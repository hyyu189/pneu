...
> Status: historical record — dispatch for the independent 1.4 review
...
`handoff/archive/architecture-review-1.4-track-collisions.md` until you have committed
...
- There are four other 1.4 tracks live in sibling worktrees (`handoff/archive/t1-brief-1.4.md`
...
1. Read `handoff/architecture-review-1.4.md` and
   `handoff/archive/architecture-review-1.4-track-collisions.md`.
