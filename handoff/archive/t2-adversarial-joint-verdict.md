...
> Status: historical record — T2 adversarial joint verdict
...
`handoff/archive/t2-adversarial-review-charter.md`. Its raw findings are in
`handoff/archive/t2-adversarial-findings-codex.md`, unedited.
