...
> Status: superseded by docs/compatibility.md "Canonical app-server host" — the daemon-join adoption shipped in 1.4

Status: product proposal only. No code changes. Builds on
`handoff/archive/codex-env-channel-proposal.md` (transport gap),
