...
remain stable in 1.3.4. Project state remains under `.roundtable/`, and
...
```bash
tar -xzf pneu-1.3.4-macos.tar.gz
cd pneu-1.3.4
./install
...
management, and multi-auth switching remain out of scope for 1.3.4. The
