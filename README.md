...
remain stable in 1.0.0. Project state remains under `.roundtable/`, and
...
```bash
tar -xzf pneu-1.0.0-macos.tar.gz
cd pneu-1.0.0
./install
...
management, and multi-auth switching remain out of scope for 1.0.0.
